...
obst1 = Obstacle('rect',[-3, 5, 2,3], [0,0], chaos*np.eye(2), 1.5, goalLoc = goalLoc)
obst2 = Obstacle('circle',[2,4,3], [0,0], chaos*np.eye(2), 1.5, goalLoc = goalLoc)
...
obst6 = Obstacle('rect', [-4,9,3,2], [0,0], chaos*np.eye(2), 0, goalLoc = goalLoc)
obst7 = Obstacle('circle',[-8,-10,1], [0,0], chaos*np.eye(2), 0, goalLoc = goalLoc)
